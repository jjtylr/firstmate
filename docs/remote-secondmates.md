...
Remote launches follow the same exact verified canonical adapter-token contract as local launches; [`configuration.md`](configuration.md#harness-support) owns that operator-facing limit.
