...
# confirm "question" — y/N gate; returns success on yes. Call it as a test:
#   if confirm "Rotate the key?"; then …; fi      or      confirm "…" || return 0
# Never bare. Under `set -e` a bare call answered "n" ends the wizard, exit 1,
# no message, mid-procedure.
confirm() {
  local reply=""
